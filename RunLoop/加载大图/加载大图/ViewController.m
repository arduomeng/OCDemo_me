...
/*
  卡顿： 一次RunLoop最多加载18张大图
  监听RunLoop 一次循环加载一张大图
 */
- (void)viewDidLoad {
    [super viewDidLoad];
    _max = 18;
...
-(void)addRunloopObserver{
    ...
    //创建观察者 kCFRunLoopBeforeWaiting ： 观察RunLoop的运行状态
    /*
    ...
    //添加当前RunLoop的观察者
    // kCFRunLoopDefaultMode 默认模式 当拖拽的时候不加载图片
    // kCFRunLoopCommonModes 通用模式 拖拽的时候也加载图片

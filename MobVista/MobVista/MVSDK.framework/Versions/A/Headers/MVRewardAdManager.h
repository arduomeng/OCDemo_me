 ...
 */
- (void)onVideoAdLoadSucceed:(nullable NSString *)unitId;
 ...
 */
- (void)onVideoAdShowSucess:(nullable NSString *)unitId;
 ...
 */
- (void)onVideoAdShowFaild:(nullable NSString *)unitId withError:(nonnull NSError *)error;
